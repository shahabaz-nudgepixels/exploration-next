...
import { scaledToViewport, viewportPositionToScaled } from "@/utils/pdf/lib/coordinates";
import getBoundingRect from "@/utils/pdf/lib/get-bounding-rect";
import getClientRects from "@/utils/pdf/lib/get-client-rects";
import groupHighlightsByPage from "@/utils/pdf/lib/group-highlights-by-page";
import {
  asElement,
...
if (typeof window !== 'undefined') {
  // Only load PDF.js components on client-side
